...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button3->Text = L"Удалить строку и столбец с мин. элементом";
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		textBox2->Text = "";
		   ...
		   //-Кнопка "Удалить строку и столбец с мин. элементом:"
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (textBox1->Lines->Length != n)
		{
			...
			MessageBox::Show("Несовпадение количества строк!\n",
				"Error",
				MessageBoxButtons::OK,
				MessageBoxIcon::Error);
		...
		int rows = 0;
		bool is_valid = true;
		// Матрицу А без выделенных строк выводим в поле вывода результата (Memo2)
		for (i = 0; i < n; i++) {
			is_valid = true;
			for (k = 0; k < ind; k++)
